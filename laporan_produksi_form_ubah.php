...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Detail Laporan Produksi Kerja</h3>
...
<a href="home.php?go=laporan_produksi" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>	
...
<?php
$sql = "select * from tbllaporan_produksi where Id_laporan ='$_GET[id]'";
...
<table width="500" border="0" height="600">
  <tr>
    <td>Item</td>
    <td><input name="itemtxt" class="form-control required" type="text" id="itemtxt" value="<?php echo $record['item'] ?>" size="5" maxlength="15" /></td>
    </td>
  </tr>
  <tr>
    <td>Color</td>
    <td><input name="colortxt" class="form-control required" type="text" id="colortxt" value="<?php echo $record['color'] ?>" size="5" maxlength="15"  /></td>
    </td>
  </tr>
  <tr>
    <td>Model</td>
    <td><input name="modeltxt" class="form-control required" type="text" id="modeltxt" size="5" value="<?php echo $record['model'] ?>" maxlength="15" readonly /></td>
    </td>
  </tr>
  <tr>
    <td>Size L</td>
    <td><input name="ltxt" class="form-control required" type="text" id="ltxt" size="5" maxlength="15" value="<?php echo $record['size_l'] ?>" readonly /></td>
    </td>
  </tr>
  <tr>
    <td>Hasil Produksi L</td>
    <td><input name="hasiltxt" class="form-control required" type="text" id="hasiltxt" size="5" value="<?php echo $record['hasil_l'] ?>" maxlength="15" onChange="updatetotaltxt()"  /></td>
    </td>
  </tr>
  <tr>
    <td>Total BS</td>
    <td><input name="totalbstxt" class="form-control required" type="text" id="totalbstxt" size="5" value="<?php echo $record['bs_l'] ?>" maxlength="15" onChange="updatetotaltxt()" /></td>
    </td>
  </tr>
  <tr>
    <td>Total Produksi L</td>
    <td><input name="totaltxt" class="form-control required" type="text" id="totaltxt" size="5" value="<?php echo $record['total_l'] ?>" maxlength="15" readonly/></td>
    </td>
  </tr>
  <tr>
    <td>Size S</td>
    <td><input name="stxt" class="form-control required" type="text" id="stxt" size="5" value="<?php echo $record['size_s'] ?>" maxlength="15" readonly /></td>
    </td>
  </tr>
  <tr>
    <td>Hasil Produksi S</td>
    <td><input name="hasilstxt" class="form-control required" type="text" id="hasilstxt" size="5" value="<?php echo $record['hasil_l'] ?>" maxlength="15" onChange="updatetotalptxt()" /></td>
    </td>
  </tr>
  <tr>
    <td>Total BS</td>
    <td><input name="totalstxt" class="form-control required" type="text" id="totalstxt" size="5" value="<?php echo $record['bs_s'] ?>" maxlength="15" onChange="updatetotalptxt()"  /></td>
    </td>
  </tr>
  <tr>
    <td>Total Produksi S</td>
    <td><input name="totalptxt" class="form-control required" type="text" id="totalptxt" size="5" value="<?php echo $record['total_s'] ?>" maxlength="15" readonly/></td>
    </td>
