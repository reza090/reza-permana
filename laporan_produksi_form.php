...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Laporan Produksi Kerja</h3>
...
<table width="500" border="0" height="600">
  ...
  <tr>
    ...
    <td><input name="hasiltxt" class="form-control required" type="text" id="hasiltxt" size="5" maxlength="15" onChange="updatetotaltxt()"  /></td>
    </td>
  </tr>
  <tr>
    <td>Total BS</td>
    <td><input name="totalbstxt" class="form-control required" type="text" id="totalbstxt" size="5" maxlength="15" onChange="updatetotaltxt()" /></td>
    </td>
  </tr>
  <tr>
    <td>Total Produksi L</td>
    <td><input name="totaltxt" class="form-control required" type="text" id="totaltxt" size="5" maxlength="15" readonly="readonly"/></td>
    </td>
  </tr>
  <tr>
    <td>Size S</td>
  ...
  <tr>
    ...
    <td><input name="hasilstxt" class="form-control required" type="text" id="hasilstxt" size="5" maxlength="15" onChange="updatetotalptxt()" /></td>
    </td>
  </tr>
  <tr>
    <td>Total BS</td>
    <td><input name="totalstxt" class="form-control required" type="text" id="totalstxt" size="5" maxlength="15" onChange="updatetotalptxt()"  /></td>
    </td>
  </tr>
  <tr>
    <td>Total Produksi S</td>
    <td><input name="totalptxt" class="form-control required" type="text" id="totalptxt" size="5" maxlength="15" readonly="readonly"/></td>
    </td>
  </tr>
  <tr>
    <td></td>
    <td><input name="simpan" class="btn btn-primary" type="submit" value="Tambah"></td>
  </tr>
</table>
</form>
