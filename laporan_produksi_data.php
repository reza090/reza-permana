...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Laporan Produksi Kerja</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                                                   <table class="table table-hover table-condensed table-striped" align="left">
                       <right> <a href="home.php?go=laporan_produksi_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   	   <a href="cetak/cetak_laporan_kerja.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/lapkerja_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>nama item</th><th>model</th><th>color</th><th>aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
  <?php 
$no=1;
$sql = "select * from tbllaporan_produksi order by Id_laporan asc";
...
?>
                                    ...
                                    <tr>
                                       ...
                                       <td> <a href='home.php?go=laporan_produksi_form_ubah&amp;id=<?php echo $record['Id_laporan']; ?>'
             class="btn btn-info"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp
                                            <a href='home.php?go=laporan_produksi_hapus&amp;id=<?php echo $record['Id_laporan']; ?>'onclick="return confirm('Yakin data akan dihapus?') ";
