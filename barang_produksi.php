...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Barang Produksi</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                           
                       ...
                       <right> 
										   <a href="cetak/cetak_barang_produksi.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/barang_produksi_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>Nama item</th><th>Color</th>
                                        <th>Model</th><th>Size l</th><th>Size S</th><th>ER L%</th><th>ER S%</th>
                                    </tr>
                                </thead>
                                <tbody>
  <?php 
$no=1;
$sql = "select * from tblbarang_produksi order by id_barangp asc";
