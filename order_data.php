...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Order Masuk</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<table class="table table-hover table-condensed table-striped" align="left">
                       <right> <a href="home.php?go=order_form" class="btn btn-success">
                            ...
                            <a href="export/order_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
  ...
  <?php 
$no=1;
$sql = "select * from tblorder_formula order by id_order asc";
...
?>
                                    ...
                                    <tr>
                                       ...
                                       <td> <a href='home.php?go=order_form_ubah&amp;id=<?php echo $record['id_order']; ?>'
             class="btn btn-info"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp
                                            <a href='home.php?go=order_hapus&amp;id=<?php echo $record['id_order']; ?>'onclick="return confirm('Yakin data akan dihapus?') ";
