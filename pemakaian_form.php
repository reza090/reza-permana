...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Pemakaian Barang Tangker</h3>
...
<a href="home.php?go=pemakaian" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>
<style type="text/css">
div.ui-datepicker{
 font-size:12px;
}
...
<form id="form1" name="form1" method="post" action="home.php?go=pemakaian_simpan">
  <table width="900" border="0">
    <tr>
      ...
      <td width="11%" align="left" valign="middle">No Pemakaian</td>
      <td width="1%" align="left" valign="middle">:</td>
      <td width="24%" align="left" valign="top"><input name="nofakturtxt" type="text" id="nofakturtxt" value="<?php echo "SSIPN-$tgl-$kode"?>" size="7" maxlength="50" readonly /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle">:</td>
      <td colspan="4" align="left" valign="top"><input name="hrgjualtxt" type="text" id="hrgjualtxt" size="5" maxlength="15" readonly /></td>
    </tr>
    <tr>
...
<?php
$no=1;
$nofaktur ="SSIPN-$tgl-$kode";
$sql1 = "select * from tbltransaksi_pemakaian_rinci inner join tblbarang on tbltransaksi_pemakaian_rinci.kode_barang = tblbarang.kode_barang where tbltransaksi_pemakaian_rinci.no_pemakaian ='$nofaktur'";
...
<?php
$sql_total = "select sum(sub_total) as gtotal from tbltransaksi_pemakaian_rinci where tbltransaksi_pemakaian_rinci.no_pemakaian ='$nofaktur'";
