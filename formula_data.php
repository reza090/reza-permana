...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Formula</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                           
                       ...
                       <right> <a href="home.php?go=formula_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   <a href="cetak/cetak_formula.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/formula_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>no order</th><th>No po</th>
                                        <th>nama item</th><th>model</th><th>jenis</th><th>aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
  <?php 
$no=1;
$sql = "select * from tblformula order by id_formula asc";
...
?>
             ...
             class="btn btn-info"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp
                                           <a href='home.php?go=formula_hapus&amp;id=<?php echo $record['id_formula']; ?>' onclick="return confirm('Yakin data akan dihapus?') ";
