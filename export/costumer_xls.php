...
$objPHPExcel->getProperties()->setCreator("Candra Adi Putra")
      ...
      ->setSubject("Office 2007 XLSX Test Document")
       ...
       ->setCategory("tblpelanggan");
  
// Add some data
$objPHPExcel->setActiveSheetIndex(0)
       ->setCellValue('A1', 'No')
       ->setCellValue('B1', 'Kode Costumer')
       ->setCellValue('C1', 'Nama Costumer')
...
$objPHPExcel->setActiveSheetIndex(0)
     ...
     ->setCellValue("B$baris", $row['kode_pelanggan'])
     ->setCellValue("C$baris", $row['nama_pelanggan'])
...
header('Content-Disposition: attachment;filename="costumer.xls"');
