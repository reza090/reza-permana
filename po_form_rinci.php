...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data PO Detail</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<?php
$sql = "select * from tbltransaksi_po inner join tblpemasok on tbltransaksi_po.kode_pemasok = tblpemasok.kode_pemasok where tbltransaksi_po.no_po ='$_GET[id]'";
$proses = mysql_query($sql);
$record = mysql_fetch_array($proses);
$tgl = substr($record['tanggal'],8,2)."-".substr($record['tanggal'],5,2)."-". substr($record['tanggal'],0,4); 	
?>
	<a href="cetak/cetak_po_rinci.php?no_po=<?php echo $record[no_po];?>" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/po_rinci_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
...
<form id="form1" name="form1" method="post" action="home.php?go=Pembelian">
  <table width="900" border="0" >
    <tr>
      <td width="12%" align="left" valign="middle">No PO</td>
      <td width="1%" align="left" valign="middle">:</td>
      <td width="87%" align="left" valign="top"><input name="nofakturtxt" type="text" id="nofakturtxt" value="<?php echo $record['no_po'] ?>" size="7" maxlength="50" readonly /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td align="left" valign="middle">:</td>
      <td align="left" valign="top"><input name="pemasoktxt" type="text" id="pemasoktxt" value="<?php echo $record['kode_pemasok'] ?>-<?php echo $record['nama_pemasok'] ?>" size="35" maxlength="35" readonly /></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Nama Pemasok</td>
      <td align="left" valign="middle">:</td>
      <td align="left" valign="top"><input name="nmpemasoktxt" type="text" id="nmpemasoktxt" 
      value="<?php echo $record['alamat'] ?>-<?php echo $record['nama_pemasok'] ?>" size="45" maxlength="45" readonly /></td>
    </tr>
...
<?php
$no=1;
$sql1 = "select * from tbltransaksi_po_rinci inner join tblbarang on tbltransaksi_po_rinci.kode_barang = tblbarang.kode_barang where tbltransaksi_po_rinci.no_po ='$record[no_po]'";
...
<?php
$sql_total = "select sum(sub_total) as gtotal from tbltransaksi_po_rinci where tbltransaksi_po_rinci.no_po ='$record[no_po]'";
