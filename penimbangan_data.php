...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Hasil Penimbangan</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                        <table class="table table-hover table-condensed table-striped">
                       <right> <a href="home.php?go=penimbangan_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   <a href="cetak/cetak_hasil_penimbangan.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/hasil_penimbangan_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>Item</th><th>Model</th>
                                        <th>Color</th><th>Size L</th><th>Size S</th><th>Keterangan</th><th>Shift</th><th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
 <?php 
  $no=1;                             
$sql = "select * from tblpenimbangan order by id_penimbangan desc";
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $record['size_l'] ?></td>
                                         <td> <?php echo $record['size_s'] ?></td>
          								...
          								<td><a href='home.php?go=penimbangan_form_ubah&amp;id=<?php echo $record['id_penimbangan']; ?>'
             class="btn btn-info"><i class='glyphicon glyphicon-pencil'></i></a>&nbsp
                                            <a href='home.php?go=penimbangan_hapus&amp;id=<?php echo $record['id_penimbangan']; ?>'onclick="return confirm('Yakin data akan dihapus?') ";
