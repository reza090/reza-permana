...
<div class="main">
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Pemakaian Barang Rinci</h3>
...
?>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">     
          <a href="cetak/cetak_penjualan_rinci.php?no_faktur=<?php echo $record[no_faktur];?>" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
...
<form id="form1" name="form1" method="post" action="home.php?go=Penjualan">
  ...
  <table width="700" border="0" >
    <tr>
      <td width="15%" align="left" valign="middle">No Faktur</td>
      <td width="1%" align="left" valign="middle">:</td>
      <td width="87%" align="left" valign="top"><input name="nofakturtxt" type="text" id="nofakturtxt" value="<?php echo $record['no_faktur'] ?>" size="10" maxlength="150" readonly="readonly" /></td>
    </tr>
    <tr>
