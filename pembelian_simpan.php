...
if(isset($_POST['tambahbtn'])){
	if(!$_POST['kdbarangtxt'] || !$_POST['jmltxt']){
		...
		$sql = "INSERT INTO tbltransaksi_beli_rinci(no_faktur,kode_barang,harga_beli,jumlah,sub_total) VALUES ('$_POST[nofakturtxt]','$_POST[kdbarangtxt]','$_POST[hrgtxt]','$_POST[jmltxt]','$_POST[subtotaltxt]')";
