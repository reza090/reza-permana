...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Data Order</h3>
...
<body>
<?php
$sql = "select * from tblorder_formula order by id_order desc";
$proses = mysql_query($sql);
$record = mysql_fetch_array($proses);
$kode = $record['id_order']+1;
?>
<form id="form1" form action="home.php?go=order_simpan" method="post" enctype="multipart/form-data">
<table width="700" border="0" height="300">
  <tr>
    <td>No. Order</td>
    <td>&nbsp;<input name="no" class="form-control required" value="<?php echo "SSI-$kode"?>" type="text" id="no" /></td>
  </tr>
  <tr>
    <td>No PO</td>
    <td>&nbsp;<input name="nopo" class="form-control required" type="text" id="nopo" /></td>
  </tr>
  <tr>
    <td>Item</td>
    <td>&nbsp;<input name="item" class="form-control required" type="text" id="item" /></td>
  </tr>
  <tr>
    <td>Color</td>
    <td>&nbsp;<input name="color" class="form-control required" type="text" id="color" /></td>
  </tr>
  <tr>
    <td>Model</td>
    <td>&nbsp;<input name="model" class="form-control required" type="text" id="model" /></td>
  </tr>
  <tr>
    <td>Quantity l</td>
    <td>&nbsp;<input name="l" class="form-control required" type="text" id="l" /></td>
  </tr>
  <tr>
    <td>Quantity s</td>
    <td>&nbsp;<input name="s" class="form-control required" type="text" id="s" /></td>
  </tr>
  <tr>
    <td>ER L%</td>
    <td>&nbsp;<input name="erl" class="form-control required" type="text" id="l" /></td>
  </tr>
  <tr>
    <td>ER S%</td>
    <td>&nbsp;<input name="ers" class="form-control required" type="text" id="s" /></td>
  </tr>
  <tr>
    <td></td>
    <td></br><input name="simpan" class="btn btn-primary" type="submit" id="simpan" value="simpan"/></td>
  </tr>
</table>
