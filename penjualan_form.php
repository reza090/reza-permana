...
<div class="main">
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Pemakaian Barang</h3>
...
<form id="form1" name="form1" method="post" action="home.php?go=Penjualan_Simpan">
  <table width="900" border="0" >
    <tr>
      ...
      <td width="49%" align="left" valign="top"><input name="kdbarangtxt"  type="text" id="kdbarangtxt" size="35" maxlength="50" /></td>
    ...
    <tr>
      ...
      <td align="left" valign="middle">:</td>
      <td colspan="4" align="left" valign="top"><input name="hrgjualtxt"  type="text" id="hrgjualtxt" size="10" maxlength="15" readonly="readonly" /></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Jumlah</td>
      <td align="left" valign="middle">:</td>
      <td colspan="4" align="left" valign="top"><input name="jmltxt"  type="text" id="jmltxt" size="15" maxlength="15" onkeyup="subtotal(this.value,getElementById('jmltxt').value);" onkeypress="return isNumberKey(event)" /></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Sub Total</td>
      <td align="left" valign="middle">:</td>
      <td colspan="4" align="left" valign="top"><input name="subtotaltxt"  type="text" id="subtotaltxt" size="15" maxlength="15" readonly="readonly"/></td>
    </tr>
    <tr>
