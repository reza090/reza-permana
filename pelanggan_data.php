...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Costumer</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                        <table class="table table-hover table-condensed table-striped">
                       <right> <a href="home.php?go=Pelanggan_Form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
								<a href="cetak/cetak_pelaggan.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/costumer_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>Kode Costumer</th><th>Nama Costumer</th></th><th>Nama Perusahaan</th>
  ...
  <?php 
  $no=1;                             
$sql = "select * from tblpelanggan order by id_pelanggan asc";
...
?>        
                                    <tr>
										...
										<td> <?php echo $record['telepon'] ?></td>
          								<td><a href='?go=Pelanggan_Form_Ubah&amp;id=<?php echo $record['id_pelanggan']; ?>'
