...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Laporan Barang Produksi</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">
                       ...
                       <right> <a href="home.php?go=laporan_hasil_produksi_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   <a href="cetak/cetak_lappro.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/lappro_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
										   </right>
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>No. PO</th><th>No. Order</th><th>Item</th><th>color</th><th>Model</th><th>Hasil L</th><th>Hasil S</th><th>aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
<?php 
  $no=1;                             
$sql = "select * from tbllaporan_hasil_produksi order by id_hasillap desc";
...
?>       
                                    <tr>
                                        ...
                                        <td> <?php echo $record['no_order'] ?></td>
                                        <td> <?php echo $record['nama_item'] ?></td>
                                         <td><?php echo $record['model'] ?></td>
          								<td> <?php echo $record['color'] ?></td>
                                        <td> <?php echo $record['quantiity_l'] ?></td>
                                        <td> <?php echo $record['quantiity_s'] ?></td>
                                       <td> <a href=''
