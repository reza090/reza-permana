...
<table width="600" border="0" height="400">
  ...
  <tr>
    <td>Size L</td>
    <td><input name="ltxt" class="form-control required" type="text" id="ltxt" size="5" maxlength="15" /></td>
    </td>
  </tr>
  <tr><tr>
    <td>Size S</td>
    <td><input name="stxt" class="form-control required" type="text" id="stxt" size="5" maxlength="15"  /></td>
    </td>
  </tr>
  <tr>
  <tr>
    <td>Keterangan</td>
    <td><input name="kettxt" class="form-control required" type="text" id="kettxt" size="5" maxlength="25"  /></td>
    </td>
  </tr>
  <tr>
<tr>
