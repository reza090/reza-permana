...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Tambah Data Costumer</h3>
...
<form  id='form1' method="POST" 
                      action='home.php?go=Pelanggan_Simpan'
  ...
  <tr>
    ...
    <td><input type="text" class="form-control required" id="kdtxt" name='kdtxt'
        value="<?php echo "COS-$kode"?>" readonly maxlength="50"></td>
  </tr>
  <tr>
    <td>Nama Costumer</td>
    <td><input type="text" class="form-control required" id="nmtxt" name='nmtxt'
       placeholder="Masukan nama Costumer" maxlength="50"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> <input type="text" class="form-control required" id="tlpntxt" name='tlpntxt'
       placeholder="Masukan nomer Telepon" maxlength="50"></td>
  </tr>
  <tr>
    <td>Alamat</td>
