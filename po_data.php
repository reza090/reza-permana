...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Purchase Order </h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">
                       ...
                       <right> <a href="home.php?go=po_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   <a href="cetak/cetak_po.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/po_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>No. PO</th><th>Tanggal</th>
                                        <th>Supplier</th><th>Total</th><th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
  <?php 
$no=1;
$sql = "select * from tbltransaksi_po inner join tblpemasok on tbltransaksi_po.kode_pemasok = 
tblpemasok.kode_pemasok order by tbltransaksi_po.id desc";
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp.<?php echo number_format($record['total'], 0, ',','.') ?></td>
          								<td><a href='?go=po_form_rinci&amp;id=<?php echo $record['no_po']; ?>'
