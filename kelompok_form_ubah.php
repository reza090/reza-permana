...
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<a href="home.php?go=Kelompok" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>
<?php
...
<form  id='form1' method="POST" 
                      action='home.php?go=Kelompok_Simpan'
  ...
  <tr>
    <td>Kode Kelompok</td>
    <td><input type="text" class="form-control required" id="kdkelompoktxt" name='kdkelompoktxt'
        value="<?php echo $record['kode_kelompok'] ?>" readonly="readonly" maxlength="50"></td>
  </tr>
  <tr>
    <td>Nama Kelompok</td>
    <td><input type="text" class="form-control required" id="nmkelompoktxt" name="nmkelompoktxt"
       placeholder="Masukan nama Kelompok" maxlength="50" value="<?php echo $record['nama_kelompok'] ?>"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
