...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Data Laporan Pemakaian</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<a href="home.php?go=laporan_pemakaian_form" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>

<form id="form1" name="form1" method="post" action="laporan_pemakaian_cetak.php" target="new">
  <table width="700" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <th width="637" align="left" valign="middle" bgcolor="#8B9CC4" scope="col"><font color="#000000" face="Tahoma, Geneva, sans-serif" size="2"><b>DATA TRANSAKSI PEMAKAIAN PERIODE :
 ...
 <input name="tglsampaitxt" type="text" id="tglsampaitxt" value="<?php echo $_POST['tglsampai'] ?>" size="10" readonly="readonly" /></b></font></th>
  <th width="55" align="right" valign="middle" bgcolor="#8B9CC4" scope="col"><a href="laporan_pemakaian_cetak.php"><input type=image img src="Gambar/cetak.png" width="16" height="16" title="Cetak" /></a></th>
  </tr>
</table>
<table width="700" border="0" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <th width="6%" align="center" scope="col" bgcolor="#CCCCCC">No</th>
    <th width="22%" align="left" scope="col" bgcolor="#CCCCCC">No Pemakaian</th>
...
$sql = "select * from tbltransaksi_pemakaian where tanggal >='$tgl1' and tanggal <='$tgl2' order by id desc";
