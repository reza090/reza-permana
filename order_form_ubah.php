...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Detail Data Order</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
	...
	<a href="home.php?go=order" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a>
...
<?php
$sql = "select * from tblorder_formula where id_order ='$_GET[id]'";
$proses = mysql_query($sql);
$record = mysql_fetch_array($proses);
?>

<body>
<form id="form1" form action="" method="post" enctype="multipart/form-data">
<table width="700" border="0" height="300">
  <tr>
    <td>No. Order</td>
    <td>&nbsp;<input name="no" class="form-control required" value="<?php echo $record['no_order']?>" type="text" id="no" /></td>
  </tr>
  <tr>
    <td>No PO</td>
    <td>&nbsp;<input name="nopo" class="form-control required" value="<?php echo $record['no_po']?>" type="text" id="nopo" /></td>
  </tr>
  <tr>
    <td>Item</td>
    <td>&nbsp;<input name="item" class="form-control required" value="<?php echo $record['nama_item']?>" type="text" id="item" /></td>
  </tr>
  <tr>
    <td>Color</td>
    <td>&nbsp;<input name="color" class="form-control required" value="<?php echo $record['color']?>" type="text" id="color" /></td>
  </tr>
  <tr>
    <td>Model</td>
    <td>&nbsp;<input name="model" class="form-control required" value="<?php echo $record['model']?>" type="text" id="model" /></td>
  </tr>
  <tr>
    <td>Quantity l</td>
    <td>&nbsp;<input name="l" class="form-control required" value="<?php echo $record['quantity_l']?>" type="text" id="l" /></td>
  </tr>
  <tr>
    <td>Quantity s</td>
    <td>&nbsp;<input name="s" class="form-control required"value="<?php echo $record['quantity_s']?>" type="text" id="s" /></td>
  </tr>
  <tr>
    <td>ER L%</td>
    <td>&nbsp;<input name="erl" class="form-control required" type="text" value="<?php echo $record['er_l']?>" id="l" /></td>
  </tr>
  <tr>
    <td>ER S%</td>
    <td>&nbsp;<input name="ers" class="form-control required" type="text" value="<?php echo $record['er_s']?>" id="s" /></td>
  </tr>
