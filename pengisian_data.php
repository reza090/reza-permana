...
<table width="1394" border="0" align="left">
  <tr>
    ...
    <td width=1000 height="40"><h3 valign="top" align="center">Pengisian Tangker</h3>
<div class='col-md-8 col-md-offset-2'>
  ...
  <tr>
    <td colspan="3" align="left" valign="top">                                           <table class="table table-hover table-condensed table-striped">
                       <right> <a href="home.php?go=pengisian_form" class="btn btn-success">
                                           <i class='glyphicon glyphicon-plus'></i> Add</a>
										   <a href="cetak/cetak_pengisian.php" class="btn btn-primary"><i class='glyphicon glyphicon-print'></i> Print</a>
                            <a href="export/pengisian_xls.php" class="btn btn-success"><i class='glyphicon glyphicon-cloud-download'></i> Excel</a>
                            <a href="home.php" class="btn btn-default"><i class='glyphicon glyphicon-repeat'></i> Kembali</a></right>
                                <thead>
                                    <tr>
                                        <th>No</th><th>Tanggal</th><th>Eva 1316</th><th>Eva 1328</th><th>DF 110</th><th>Elvax 3388</th><th>Eva 1315</th><th>Shift</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php 
  $no=1;                             
$sql = "select * from tblpengisian order by id_isi desc";
...
?> 
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $record['eva1316']?></td>
                                         <td> <?php echo $record['eva1328']?></td>
                                          <td> <?php echo $record['df110']?></td>
                                           <td> <?php echo $record['elvax3388']?></td>
                                            <td> <?php echo $record['eva1315']?></td>
                                        <td> <?php echo $record['shift'] ?></td>
          								<td><a href=''
             class="btn btn-info"><i class='glyphicon glyphicon-arrow-left'></i></a>&nbsp
