...
<form id="form1" name="form1" method="post" action="home.php?go=Penjualan_Simpan">
  <table width="700" border="0" align="center">
    <tr>
      ...
      <td width="1%" align="left" valign="middle">:</td>
      <td width="24%" align="left" valign="top"><input name="nofakturtxt" type="text" id="nofakturtxt" value="<?php echo "PEN-$tgl-$kode"?>" size="7" maxlength="50" readonly="readonly" /></td>
    </tr>
    <tr>
