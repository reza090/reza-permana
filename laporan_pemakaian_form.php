...
<form name="form1" method="post" action="home.php?go=laporan_pemakaian">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr>
      ...
      <td>:</td>
      <td><input name="tglsampai" class="form-control required" type="text" id="tglsampai" value="<?php echo date('d-m-Y') ?>" size="6" maxlength="10" readonly /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
